...
const blogPosts = [
  {
    id: 1,
    title: "The Legacy of Tanjore Paintings",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        {blogPosts.map((post) => (
          ...
          >
            ...
            {/* Overlay gradient */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>

            {/* Text content */}
            <div className="p-6 bg-white relative -mt-16 rounded-t-3xl z-10 shadow-md">
